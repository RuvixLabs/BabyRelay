...
2. Upload an App Store/TestFlight build, add the required ASC App Review
   ...
   privacy nutrition once the BabyRelay ASC route stops returning shell-only/500
   states.
